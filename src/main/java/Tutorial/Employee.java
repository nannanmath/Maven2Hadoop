...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4905770475248425973L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"Tutorial\",\"fields\":[{\"name\":\"Name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"}]}");
   ...
   */
  public static Tutorial.Employee.Builder newBuilder() {
    return new Tutorial.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static Tutorial.Employee.Builder newBuilder(Tutorial.Employee.Builder other) {
    return new Tutorial.Employee.Builder(other);
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static Tutorial.Employee.Builder newBuilder(Tutorial.Employee other) {
    return new Tutorial.Employee.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(Tutorial.Employee.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(Tutorial.Employee other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.Name)) {
        this.Name = data().deepCopy(fields()[0].schema(), other.Name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public Tutorial.Employee.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Tutorial.Employee.Builder clearName() {
      Name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public Tutorial.Employee.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public Tutorial.Employee.Builder clearAge() {
